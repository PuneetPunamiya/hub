  ...
  it('it should return displayName', (done) => {
    ...
    when(
      ...
      () => {
        ...
        const displayName = store.resources.get('aws-cli')?.displayName;
  ...
  it('it should return webURL', (done) => {
    ...
    when(
      ...
      () => {
        ...
        const webURL = store.resources.get('aws-cli')?.webURL;

        expect(webURL).toBe('https://github.com/tektoncd/catalog/tree/master/task/aws-cli/0.1/');
        done();
      }
    );
  });
  it('it should return short description', (done) => {
    const store = ResourceStore.create(
      {},
      {
        api,
    ...
    when(
      ...
      () => {
        ...
        const description = store.resources.get('aws-cli')?.shortDescription;
  ...
  it('it should return detail description', (done) => {
    ...
    when(
      ...
      () => {
        ...
        const description = store.resources.get('buildah')?.detailDescription;
  ...
  it('it should return install command', (done) => {
    ...
    when(
      ...
      () => {
        ...
        const installCmd = store.resources.get('aws-cli')?.installCommand;

        expect(installCmd).toBe(
