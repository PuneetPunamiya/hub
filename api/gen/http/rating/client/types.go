...
// UpdateResponseBody is the type of the "rating" service "Update" endpoint
// HTTP response body.
type UpdateResponseBody struct {
	// Average Rating of resource
	AvgRating *float64 `form:"avgRating,omitempty" json:"avgRating,omitempty" xml:"avgRating,omitempty"`
}
...
// NewUpdateResultOK builds a "rating" service "Update" endpoint result from a
// HTTP "OK" response.
func NewUpdateResultOK(body *UpdateResponseBody) *rating.UpdateResult {
	v := &rating.UpdateResult{
...
func ValidateUpdateResponseBody(body *UpdateResponseBody) (err error) {
	if body.AvgRating == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("avgRating", "body"))
	}
	return
}
