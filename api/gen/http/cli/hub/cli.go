...
func UsageExamples() string {
   ...
   ]' --limit 17876575713650742907 --exact false` + "\n" +
...
func ParseEndpoint(
	...
	var (
		...
		resourceQueryExactFlag = resourceQueryFlags.String("exact", "", "")
	...
	)
	{
		...
		case "resource":
			...
			case "query":
				endpoint = c.Query()
				data, err = resourcec.BuildQueryPayload(*resourceQueryNameFlag, *resourceQueryKindsFlag, *resourceQueryTagsFlag, *resourceQueryLimitFlag, *resourceQueryExactFlag)
			case "list":
				endpoint = c.List()
...
func resourceQueryUsage() {
	fmt.Fprintf(os.Stderr, `%s [flags] resource query -name STRING -kinds JSON -tags JSON -limit UINT -exact BOOL
