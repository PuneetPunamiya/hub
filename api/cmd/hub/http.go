...
func handleHTTPServer(ctx context.Context, u *url.URL, categoryEndpoints *category.Endpoints, resourceEndpoints *resource.Endpoints, wg *sync.WaitGroup, errc chan error, logger *zap.SugaredLogger, debug bool) {
